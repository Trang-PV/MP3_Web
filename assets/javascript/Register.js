  ...
  <div class="login--close" onclick="handleCloseRegister()">
      ...
      <form action="" id="form-1" class="register-form">
        ...
        <div class="form-input">
          ...
          <input id="fullname" type="text" placeholder="VD: Phan Văn Trang" />
          <div class="form-messenger"></div>
        </div>
        <div class="form-input">
          <label for="fullnameLogin" class="form-input-name">Tên Tài Khoản</label>
          <input id="fullnameLogin" type="text" placeholder="VD: Trang_FC" />
          <div class="form-messenger"></div>
        </div>
        <div class="form-input">
...
const handleRegister = () => {
  ...
  //     if (email.value === ACOUNTS[i].email) {
  //       emailExists = true;
  ...
  //   }
  //   if (emailExists) {
  //     return; // Ngăn chặn việc thêm tài khoản mới nếu email đã tồn tại
  //   }
  //   alert("ok đc r")
  // }
    ...
    // chưa xử lý được check trùng email
